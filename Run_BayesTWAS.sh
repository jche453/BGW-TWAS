...
geneFile=/mnt/YangFSS/data/jlunigham/Projects/BFGWAS/ROSMAP/expression_files/Gene_Exp_combination.txt
gene=WASH7P
Scripts_dir=/home/jluningham/Projects/bfGWAS_SS
Res_dir=/mnt/YangFSS/data/ROSMAP_Expr_BVSRM
geno_dir=/mnt/YangFSS/data/ROSMAP_GWAS_Segments
LDdir=/mnt/YangFSS/data/ROSMAP_GWAS_Segments/rosmap_LDs
Genome_Seg_File=/mnt/YangFSS/data/ROSMAP_GWAS_Segments/ROSMAP_GWAS_Seg_filehead2.txt
...
${Scripts_dir}/Step2.sh ${gene} ${geneFile} ${geno_dir} ${Scripts_dir} ${Res_dir} ${LDdir} ${N} ${num_cores}
