...
qsub -j y -wd ${Score_dir} -N GetRefLD_${study} -t 1-1703 -tc 30 /home/jluningham/Projects/BFGWAS/ROSMAP/Scripts/GetRefLD.sh ${geno_dir} ${pheno} ${filehead} ${LD_dir} ${Score_dir} ${LDwindow}
